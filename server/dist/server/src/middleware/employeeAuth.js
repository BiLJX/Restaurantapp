...
var employeeAuthMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var jsonResponse, session, decodedData, employee, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                decodedData = jsonwebtoken_1.default.verify(session, secret_1.EMPLOYEE_SECRET);
                if (!decodedData)
                    return [2 /*return*/, jsonResponse.notAuthorized()];
            ...
            case 2:
                employee = _a.sent();
                if (!employee[0])
                    return [2 /*return*/, jsonResponse.notAuthorized("Account not found")];
...
exports.employeeAuthMiddleware = employeeAuthMiddleware;
