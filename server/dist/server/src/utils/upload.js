...
exports.upload = exports.cropPicture = exports.uploadFile = exports.removeFile = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _c;
                    filename = replace ? dir + (0, idgen_1.makeId)() : dir;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, sharp_1.default)(buffer).extract(cropInfo).resize(resize[0], resize[1]).jpeg().toBuffer()];
                case 2:
                    imgBuffer = _e.sent();
